...
import mimikko.zazalng.puddle.exceptions.InvalidFormatException;
...
public class DataRow {
    ...
    public int getInt(String name, int def) {
        ...
        switch (getType(value)) {
            case "Double" -> value = ((Double) value).intValue();

            case "Long" -> value = ((Long) value).intValue();

            case "Float" -> value = ((Float) value).intValue();
        }
